...
```{r}
#| echo: true
chisq.test(summaryDf2wayTable, 1, correct = FALSE)
```
...
Will be far from 0 if data points share a relationship. Positive values for some direction, negative values for opposite directions.
