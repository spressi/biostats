...
As you can see in the output, R automatically chose to run Welch's *t*-test, which does not assume **variance homogeneity** in contrast to Student's *t*-test. For the latter, you can add the function parameter `var.equal = FALSE`
...
**Test for normality of *residuals***: If points fall along the line nicely, assumption is met.
